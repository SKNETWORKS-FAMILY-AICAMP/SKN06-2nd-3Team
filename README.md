...
#### RandomizedSearchCV를 이용한 성능개선:
 ...
 RandomizedSearchCV를 이용한 이유는 **GridSearchCV를 시도하였지만 모델 학습 시간이 너무 길었고**(6시간 이상) <br>
...
<br>
<br>
recall이 precision보다 더 중요하다고 판단되기는 하나 recall값이 지나치게 높게 나왔고 precision이 낮게 나옴
<br>
<br>
...
<br>
<br>
약 50,000개 정듸 샘플이 있는 데이터셋이었고 아주 심한 불균형 데이터는 아니었는데 성능지표인 f1score가 높게 나오지 못했다.<br>
딥러닝보다는 머신러닝이 더 적합한 데이터였다.

## 05. 스트림릿 예측 시각화

![스크린샷 2024-11-20 161648](https://github.com/user-attachments/assets/62f01e8c-a2dd-40f8-a35b-a425447e337b)
<br>
<br>
![스크린샷 2024-11-20 161610](https://github.com/user-attachments/assets/1628716a-a3b0-47fe-b48e-5d73bd4a552b)
